---
name: mmkc-keyword-scout-skill
description: >
  处理亚马逊 Sif 三类关键词报表，完成分层评级、竞品弱点和广告缺口分析，输出 PD 主攻词单和报告。
  English: Process Amazon Sif keyword exports for tiering, opportunity scoring, competitor weakness analysis, ad-gap review, and PD launch keyword reports.
---
