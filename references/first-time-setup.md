...
```
还没找到 Sif 工作区配置。请告诉我：
1. 你解压/克隆 skills 的文件夹路径（应包含 mmkc-keyword-scout-skill 和 .sif-config.example.json）
或
...
```
请把 mmkc-keyword-scout-skill / mmkc-keyword-tracker-skill 联接或复制到：
